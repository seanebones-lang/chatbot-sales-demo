#!/usr/bin/env python3
"""
Create PDF Instructions using WeasyPrint
Converts HTML installation guide to PDF for team members and beta testers
"""
...
def create_pdf_from_html():
    """Create PDF from the HTML installation guide"""
    print("📄 Creating PDF using WeasyPrint...")
    
    # Check if HTML file exists
    html_file = 'ios-installation-guide.html'
...
def create_enhanced_pdf():
    """Create an enhanced PDF with better styling"""
...
<head>
    ...
    <style>
        @page {{
            ...
            margin: 2cm;
            @top-center {{
                content: "Complete Islamic Study Guide Extended Edition";
                font-size: 10pt;
                color: #666;
            }}
            @bottom-center {{
...
<body>
    <div class="header">
        ...
        <p><em>Professional Installation Guide for iOS Devices</em></p>
    </div>
    ...
    <div class="footer">
        ...
        <p>This guide is designed for easy printing and distribution to your team.</p>
    </div>
</body>
</html>"""
    
    # Save enhanced HTML
    enhanced_html_file = 'ios-installation-guide-enhanced.html'
    ...
    # Convert to PDF
    output_file = 'iOS-Mobile-App-Installation-Guide-Enhanced.pdf'
...
def main():
    ...
    # Try to create PDF from existing HTML
    pdf_file = create_pdf_from_html()
    
    # Create enhanced PDF
    enhanced_pdf = create_enhanced_pdf()
    
    print("\n" + "=" * 60)
    print("🎉 PDF Creation Complete!")
    
    if pdf_file:
        print(f"📄 Basic PDF: {pdf_file}")
        print("   - Created from existing HTML")
